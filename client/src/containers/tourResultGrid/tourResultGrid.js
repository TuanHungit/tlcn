...
const TourResult = (props) => {
  ...
  const clickedTourTypeHandler = (data) => {
    console.log(data);
    setQuery((state) => {
      return {
        ...state,
              ...
              <div class='col-12 col-md-7'>
                <nav aria-label='breadcrumb'>
                  <ol class='breadcrumb'>
                    ...
                    <li class='breadcrumb-item'>
                      <a href='tour-result-grid.html#'>Tour</a>
                    </li>
                ...
                <h4 class='mt-0 line-125'>36 Tour ở Châu Âu</h4>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-inner'>
                          <div class='form-group'>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                clickedTourTypeHandler(e.target.value)
                              }
                            >
                              <option></option>
                              <option value=''>Tất cả</option>
                              <option value='Tour mới'>Tour mới</option>
                              <option value='Tour tết'>Tour tết</option>
                        ...
                        <div class='col-inner'>
                          <div class='form-group'>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                clickedSlugHandler(e.target.value)
                              }
                            >
                              ...
                              {props.destinationList
                                ? Object.values(props.destinationList).map(
                                    (el, key) => (
                                      <option value={el.slug} key={key}>
                                        {el.name}
                                      </option>
                                    )
                                  )
                      ...
                      <div class='col-12'>
                        <div class='col-inner ph-20 pv-15'>
                          ...
                          >
                            <i class='ion-android-search'></i> Tìm
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class='sort-box'>
                    <div class='d-flex align-items-center sort-item'>
                      ...
                      <div class='sort-form'>
                        <select
                          class='form-control'
                          onChange={(e) => clickedSortHandler(e.target.value)}
                        >
                          <option selected hidden>
                            Chọn
                          </option>
