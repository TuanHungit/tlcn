      ...
      <section class='page-wrapper pb-0'>
        ...
        <div class='container'>
          ...
          <div class='content-wrapper pt-50 pb-0 pb-lg-50'>
            <h4>Tin ưu đãi</h4>
            <div class='row equal-height cols-1 cols-sm-3 cols-lg-4 gap-20 d-flex justify-content-center'>
              {Object.values(props.promotionList).map((el, key) => (
                <PromotionCard key={key} promotion={el} />
              ))}
            </div>
          </div>
        </div>
