              ...
              <div class='fullwidth-horizon-sticky-inner'>
                <div class='container'>
                  <div class='fullwidth-horizon-sticky-item clearfix'>
                    <ul
                      id='horizon-sticky-nav'
                      class='horizon-sticky-nav clearfix'
                    >
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-01'>
                          Overview
                        </a>
                      </li>
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-02'>
                          Itinerary
                        </a>
                      </li>
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-03'>
                          Map
                        </a>
                      </li>
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-04'>
                          What's included
                        </a>
                      </li>
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-05'>
                          Availabilities
                        </a>
                      </li>
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-06'>
                          FAQ
                        </a>
                      </li>
                      <li>
                        <a href='tour-detail-02.html#detail-content-sticky-nav-07'>
                          Reviews
                        </a>
                      </li>
                    </ul>
              ...
              <div class='slick-carousel-inner'>
                <div class='slick-hero'>
                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/01.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/02.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/03.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/04.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/05.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/06.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/07.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/08.jpg' alt='Images' />
                    </div>
                  </div>

                  <div class='slick-item'>
                    <div class='image'>
                      <img src='images/image-slick-hero/09.jpg' alt='Images' />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class='row gap-20 gap-lg-40'>
                <div class='col-12 col-lg-8'>
                  <div class='content-wrapper'>
                    <div
                      id='detail-content-sticky-nav-01'
                      class='detail-header mb-30'
                    >
                        ...
                        <div>
                          <div class='rating-item rating-inline'>
                            ...
                            <p class='rating-text font600 text-muted font-12 letter-spacing-1'>
                              <span class='text-dark mr-3'>4.5/5</span> 26
                              reviews
                            </p>
                          </div>
                        </div>
                      ...
                      <p class='lead'>
                        In friendship diminution instrument in we forfeited.
                        Tolerably an unwilling of determine. Beyond rather
                        sooner so if up wishes.
                      </p>
                      ...
                      <p>
                        ...
                        recommend do eagerness. Commanded no of depending
                        extremity recommend attention tolerably. Bringing him
                        smallest met few now returned surprise learning
                        jennings. Objection delivered eagerness he exquisite at
                        do in. Warmly up he nearer mr merely me.
                      </p>

                      <p>
                        Or neglected agreeable of discovery concluded oh it
                        sportsman. Week to time in john. Son elegance use
                        weddings separate. Ask too matter formed county wicket
                        oppose talent. He immediate sometimes or to dependent
                        in. Everything few frequently discretion surrounded did
                        simplicity decisively. Less he year do with no sure
                        loud.
                      </p>
                      ...
                      <ul class='list-icon-data-attr font-ionicons'>
                        <li data-content='&#xf383'>
                          Excited him now natural saw passage offices you
                          minuter. Moments its musical age explain.
                        </li>
                        <li data-content='&#xf383'>
                          Farther so friends am to detract do private.
                        </li>
                        <li data-content='&#xf383'>
                          Procured is material his offering humanity laughing
                          moderate can.
                        </li>
                        <li data-content='&#xf383'>
                          She did open find pain some out. If we landlord
                          stanhill mr whatever pleasure
                        </li>
                      </ul>
                    </div>
                    ...
                    >
                      ...
                      <p>
                        Become latter but nor abroad wisdom waited. Was
                        delivered gentleman acuteness but daughters. In as of
                        whole as match asked. Pleasure exertion put add entrance
                        distance drawings. In equally matters showing greatly it
                        as. Want name any wise are able park when. Saw vicinity
                      ...
                      <ul class='itinerary-list mt-30'>
                        <li>
                          ...
                          <p>
                            ...
                            put continue. Overcame breeding or my concerns
                            removing desirous so absolute. My melancholy
                            ...
                            entered. An mr cause tried oh do shade happy.
                          </p>

                          <ul class='itinerary-meta list-inline-block text-primary'>
                            <li>
                              <i class='far fa-building'></i> Stay at Hilton
                              Hotel
                            </li>
                            <li>
                              <i class='far fa-clock'></i> Trip time: 8am -
                              4.30pm
                            </li>
                          </ul>
                        </li>
                  ...
                  <aside class='sticky-kit-02 sidebar-wrapper no-border mt-20 mt-lg-0'>
                    <div class='booking-box'>
                      ...
                      <div class='box-content'>
                        <span class='font600 text-muted line-125'>
                          Your choosen date is
                        </span>
                        <h4 class='line-125 choosen-date mt-3'>
                          <i class='ri-calendar'></i> 7 - 9 March, 2019{' '}
                          <small class='d-block'>
                            (3 days){' '}
                            <a
                        ...
                        <ul class='border-top mt-20 pt-15'>
                          <li class='clearfix'>
                            $125.99 x 2 guests
                            <span class='float-right'>$251.98</span>
                          </li>
                          <li class='clearfix'>
                            Booking fee + tax
                            <span class='float-right'>$9.50</span>
                          </li>
                          <li class='clearfix pl-15'>
                            Book now &amp; Save
                            <span class='float-right text-primary'>-$15</span>
                          </li>
                          <li class='clearfix'>
                            Other fees
                          ...
                          <li class='clearfix border-top font700'>
                            <div class='border-top mt-1'>
                              <span>Total</span>
                              <span class='float-right text-dark'>$248.58</span>
                            </div>
                          </li>
                        </ul>
                        ...
                        <p class='line-115 mt-20'>
                          ...
                          <a href='tour-detail-02.html#'>Terms of Service</a>{' '}
                      ...
                      <div class='box-bottom bg-light'>
                        ...
                        <p class='font-sm'>
                          Our custom tour program, direct call{' '}
                          <span class='text-primary'>+66857887444</span>.
                        </p>
                      </div>
                    </div>
                  </aside>
                          ...
                          <div class='col-inner'>
                            <div class='dropdown dropdown-smooth-01 dropdown-language'>
                              ...
                              >
                                <span class='image'>
                                  <img
                                    src='font-icons/flaticon-flags-4/png/260-united-kingdom.png'
                                    alt='image'
                                  />
                                </span>{' '}
                                English
                              ...
                              >
                                <div class='dropdown-menu-inner'>
                                  ...
                                  >
                                    <span class='image'>
                                      <img
                                        src='font-icons/flaticon-flags-4/png/013-italy.png'
                                        alt='image'
                                      />
                                    </span>
                                    Italiano
                                  ...
                                  >
                                    <span class='image'>
                                      <img
                                        src='font-icons/flaticon-flags-4/png/063-japan.png'
                                        alt='image'
                                      />
                                    </span>
                                    日本語
                                  ...
                                  >
                                    <span class='image'>
                                      <img
                                        src='font-icons/flaticon-flags-4/png/162-germany.png'
                                        alt='image'
                                      />
                                    </span>
                                    Deutsch
                                  ...
                                  >
                                    <span class='image'>
                                      <img
                                        src='font-icons/flaticon-flags-4/png/218-turkey.png'
                                        alt='image'
                                      />
                                    </span>
                                    Türkçe
                                  ...
                                  >
                                    <span class='image'>
                                      <img
                                        src='font-icons/flaticon-flags-4/png/238-thailand.png'
                                        alt='image'
                                      />
                                    </span>
                                    ภาษาไทย
                        ...
                        <div class='col-shrink'>
                          <div class='col-inner'>
                            <div class='dropdown dropdown-smooth-01 dropdown-currency'>
                              ...
                              >
                                <span class='icon-font'>
                                  <i class='oi oi-dollar text-primary mr-5'></i>
                                </span>{' '}
                                US dollar
                              </a>
                              <div
                              ...
                              >
                                <div class='dropdown-menu-inner'>
                                  ...
                                  >
                                    <span class='icon-font'>
                                      <i class='oi oi-dollar text-primary mr-10'></i>
                                    </span>
                                    US Dollar
                                  </a>
                                  <a
                                  ...
                                  >
                                    <span class='icon-font'>
                                      <i class='oi oi-british-pound text-primary mr-10'></i>
                                    </span>
                                    UK Pound
                                  </a>
                                  <a
                                  ...
                                  >
                                    <span class='icon-font'>
                                      <i class='oi oi-euro text-primary mr-10'></i>
                                    </span>
                                    EU Euro
                                  </a>
                                  <a
                                  ...
                                  >
                                    <span class='icon-font'>
                                      <i class='oi oi-yen text-primary mr-10'></i>
                                    </span>
                                    JP Yen
                                  </a>
                                </div>
            ...
            <div class='container'>
              <div class='row gap-50'>
                <div class='col-12 col-lg-5'>
                  ...
                  <p class='mt-20'>
                    Excited him now natural saw passage offices you minuter. At
                    by asked being court hopes. Farther so friends am to
                    detract. Forbade concern do private be. Offending residence
                    but men engrossed shy.
                  </p>
                ...
                <div class='col-shrink'>
                  <div class='col-inner'>
                    <p class='footer-copy-right'>
                      {' '}
                      &#169; 2005 – 2018{' '}
                      <span class='text-primary'>MyCompany Ltd.,</span> All
                      Rights Reserved.
                    </p>
                  </div>
                </div>
              ...
              >
                <div class='form-login'>
                  <div class='form-header'>
                    ...
                    <p>
                      Access thousands of online classes in design, business,
                      and more!
                    </p>
                  </div>
              ...
              >
                <div class='form-login'>
                  ...
                  <div class='form-body'>
                    <form method='post' action='tour-detail-02.html#'>
                      <p class='line-145'>
                        We'll send password reset instructions to the email
