                    ...
                    <div class="modal-content shadow-lg">
                        ...
                        <nav class="d-none">
                            <ul class="nav external-link-navs clearfix">
                                <li><a class="active" data-toggle="tab" href="dashboard.html#loginFormTabInModal-login">Sign-in</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="loginFormTabInModal-login">
                                ...
                                <div class="form-login">
                                                    ...
                                                    <div class="form-inner">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row mt-25">
                                                            <div class="flex-shrink-0">
                                                                <a href="dashboard.html#" class="btn btn-primary btn-wide">Sign-in</a>
                                                            </div>
                                                        ...
                                                        <a href="dashboard.html#loginFormTabInModal-forgot-pass" class="tab-external-link block mt-25 font600">Forgot password?</a>
                                                    </div>
                                    ...
                                    <div class="form-footer">
                                        <p>Not a member yet? <a href="dashboard.html#loginFormTabInModal-register" class="tab-external-link font600">Sign up</a> for free</p>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="loginFormTabInModal-register">
                                ...
                                <div class="form-login">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <form method="post" action="dashboard.html#">
                                            ...
                                            <div class="d-flex flex-column flex-md-row mt-30 mt-lg-10">
                                                <div class="flex-shrink-0">
                                                    <a href="dashboard.html#" class="btn btn-primary btn-wide mt-5">Sign-up</a>
                                                </div>
                                                <div class="pt-1 ml-0 ml-md-15 mt-15 mt-md-0">
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label line-145" for="loginFormTabInModal-acceptTerm">By clicking this, you are agree to to our <a href="dashboard.html#">terms of use</a> and <a href="dashboard.html#">privacy policy</a> including the use of cookies</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-footer">
                                        <p>Already a member? <a href="dashboard.html#loginFormTabInModal-login" class="tab-external-link font600">Sign in</a></p>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="loginFormTabInModal-forgot-pass">
                                ...
                                <div class="form-login">
                                    ...
                                    <div class="form-footer">
                                        <p>Back to <a href="dashboard.html#loginFormTabInModal-login" class="tab-external-link font600">Sign in</a> or <a href="dashboard.html#loginFormTabInModal-register" class="tab-external-link font600">Sign up</a></p>
                                    </div>
